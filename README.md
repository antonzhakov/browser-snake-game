...
- **Game Logic**: The `gameReducer` function acts as the core engine. It takes the last-known game state and an even (keyboard input or game tick) and calculates the new state (moving the snake, growing, detecting collisions, etc.). 
